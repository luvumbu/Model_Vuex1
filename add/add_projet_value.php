...
$time= time() ; 
$databaseHandler->action_sql("INSERT INTO `liste_projet_admin` (liste_projet_admin_id_sha1,liste_projet_admin_add_projet_value) VALUES ('$time','$liste_projet_admin_add_projet_value')") ;
