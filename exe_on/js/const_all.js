...
const path_form_log_onclick ="exe_off/form_log_onclick.php" ; 
...
console.log(form_log_password.value) ; 
 ...
 var ok = new Information(path_form_log_onclick); // création de la classe 
  ok.add("login", form_log_mail.value); // ajout de l'information pour lenvoi 
  ok.add("password", form_log_mail.value); // ajout d'une deuxieme information denvoi  
